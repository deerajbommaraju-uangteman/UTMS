...
class staffHome extends React.Component {
  ...
  rejectApplicaion(e) {
    ...
    axios({
    method: 'POST',
    url: 'http://10.15.15.65:9090/application-processing/staffRejectedLoans',
  ...
  approveApplicaion(e) {
    ...
    axios({
    method: 'POST',
    url: 'http://10.15.15.65:9090/application-processing/staffApprovedLoans',
    //contentType: "application/json",
    data: e.target.id,
    //config: { headers: {'Content-Type': 'application/json' }}}
    })
  ...
  componentDidMount() {
    axios.get(`http://10.15.15.65:9090/application-processing/staffRecievedApplications`)
      .then(res => {
